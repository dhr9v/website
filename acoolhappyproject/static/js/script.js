var LANGUAGES = {
    ...
    "en": {
        ...
        texts: {
            "page-title": "be happy",
            "doc-title": "be happy",
            "page-descriptions": "keep oinking pigs",
            "counter-descriptions": ["The pig is spinning", "Pig cant stop spinning"],
            "counter-unit": "spins",
            "counter-button": ["oink oink~"],
...
(() => {
    ...
    function animateHerta() {
        ...
        elem.style.top = counterButton.getClientRects()[0].bottom + scrollY - 20 + "px"
